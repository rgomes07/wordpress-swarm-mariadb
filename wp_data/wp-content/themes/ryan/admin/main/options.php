...
//			array(
//				'title'        => __( 'Need help?', 'ryan' ),
//				'priority'     => 1,
//				'button_text'  => __( 'Hire a Developer', 'ryan' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade(
			...
			array(
				...
				'price_discount'  => __( 'Upgrade Now (10% off)', 'ryan' ),
				'price_normal'	  => __( 'Use coupon at checkout for 10% off.', 'ryan' ),
				'coupon'	      => __( 'thinkup10', 'ryan' ),
